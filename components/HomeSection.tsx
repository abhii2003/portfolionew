        ...
        <section id="home" className="section flex items-center justify-center min-h-screen pt-24">
            <div className="text-center max-w-3xl">
                ...
                <div className="space-y-4 mb-8">
                    <p className="text-gray-400">For collaboration, reach out via email <Link href="mailto:abhinavkush2003@gmail.com"><span className="text-blue-400">↗</span></Link></p>
                ...
                <div className="flex items-center justify-center space-x-6">
                    <a href="/resume.pdf" download className="inline-flex items-center px-6 py-3 bg-gray-900 hover:bg-gray-800 rounded-md text-sm font-medium transition-colors border border-gray-700">
