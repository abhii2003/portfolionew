...
export default function TechnologiesSection() {
    return (
        <section className="py-16 text-center">
            ...
            <div className="mb-12">
                <h3 className="text-lg font-semibold text-gray-300 mb-6">Languages & Frameworks</h3>
            ...
            {/* Web Development */}
            <div className="mb-12">
                <h3 className="text-lg font-semibold text-gray-300 mb-6">Web Development</h3>
                <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-6 max-w-3xl mx-auto">
