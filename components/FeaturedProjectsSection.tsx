            ...
            <div className="relative">
                ...
                <div className="overflow-x-auto scrollbar-hide scroll-smooth">
                    <div className="flex space-x-6 w-max px-4 py-2">
                        {featuredProjects.map((project, index) => (
                            <div key={project.id} className="project-card rounded-lg overflow-hidden bg-[#111111] border border-[#222222] w-80 flex-shrink-0 scroll-snap-align-start" style={{ animationDelay: `${index * 0.1}s` }}>
                                {project.id === 1 ? (
                                    ...
                                    <div className="aspect-video website-thumbnail border-b border-gray-800 bg-[#1a1a1a] h-48 relative overflow-hidden">
                                        <iframe src={project.url} className="w-full h-full pointer-events-none opacity-0 transition-opacity duration-300 hide-scrollbar" loading="lazy" onLoad={(e) => { e.currentTarget.style.opacity = "1" }} style={{ overflow: 'hidden', scrollbarWidth: 'none' }}></iframe>
                ...
                <div className="flex justify-center mt-6 space-x-2">
                    {featuredProjects.map((_, index) => (
                        <div key={index} className="w-2 h-2 rounded-full bg-gray-600 hover:bg-gray-400 transition-colors cursor-pointer" onClick={() => {
