            ...
            <div className="max-w-4xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex space-x-6">
                        <Link href="/" className="nav-link text-gray-400 hover:text-white text-sm font-medium">home</Link>
                        <a href="/projects" className="nav-link text-gray-400 hover:text-white text-sm font-medium">projects</a>
